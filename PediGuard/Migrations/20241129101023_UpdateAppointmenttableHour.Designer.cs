...
namespace PediGuard.Migrations
{
    ...
    [Migration("20241129101023_UpdateAppointmenttableHour")]
    partial class UpdateAppointmenttableHour
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PediGuard.Models.Emergency", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 11, 29, 13, 10, 20, 441, DateTimeKind.Local).AddTicks(9838),
                            DepartmentId = 1,
                            Description = "Fire in the emergency room",
                            Location = "Emergency Room 1",
                            Status = "Pending",
                            UpdatedAt = new DateTime(2024, 11, 29, 13, 10, 20, 441, DateTimeKind.Local).AddTicks(9838)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 11, 29, 13, 10, 20, 441, DateTimeKind.Local).AddTicks(9840),
                            DepartmentId = 2,
                            Description = "Child with severe asthma attack",
                            Location = "Pediatrics Ward",
                            Status = "In Progress",
                            UpdatedAt = new DateTime(2024, 11, 29, 13, 10, 20, 441, DateTimeKind.Local).AddTicks(9841)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 11, 29, 13, 10, 20, 441, DateTimeKind.Local).AddTicks(9843),
                            DepartmentId = 1,
                            Description = "Power outage in the hospital",
                            Location = "Main Building",
                            Status = "Resolved",
                            UpdatedAt = new DateTime(2024, 11, 29, 13, 10, 20, 441, DateTimeKind.Local).AddTicks(9844)
                        });
                });
